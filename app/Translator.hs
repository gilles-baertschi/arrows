...
translateValuePreview (TypeWithBinaryArrowOperator _ _ _ _) = Just <$> createFunctionNamePrewiev
translateValuePreview (TypeWithUnaryArrowOperator _ _ _) = Just <$> createFunctionNamePrewiev
